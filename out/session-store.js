...
var P2PStore, Peers, connect, difflet, guid, mem, _,
...
mem = function() {
  return console.log(_.map(process.memoryUsage(), function(val, name) {
    return name + ': ' + (Math.round(val / 1024 / 1024 * 100) / 100) + ' MB';
  }, null, 2).join(', '));
};
